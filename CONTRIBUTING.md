# Contributing to homebrew-git-semver-tag
...
In short, when you submit code changes, your submissions are understood to be under the same [The Unlicense](https://github.com/timo-reymann/timo-reymann/homebrew-git-semver-tag/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
